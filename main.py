...
def attack(char_name: str, char_class: str) -> str:
    """Рассчет нанесенного урона в зависимости от выбранного класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рассчет защиты в зависимости от выбранного класса."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не смог провести защитные действия')


def special(char_name: str, char_class: str) -> str:
    """Рассчет специального урона в зависимости от выбранного класса."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не смог провести специальную атаку противнику')


def start_training(char_name: str, char_class: str) -> str:
    """Выбор действия для выбранного класса."""
    if char_class == 'warrior':
